...
public class Menu {
    ...
    private static void CarContainerInit() {
        Auto<Integer, Integer, Integer> TESLA = new Auto<>("TESLA", 2020, 30,
                40, true, 50000);

        Auto<Integer, Integer, Integer> BMW = new Auto<>("BMW", 2014, 50,
                100, true, 40000);

        Auto<Integer, Integer, Integer> MERCEDES = new Auto<>("MERCEDES", 2017, 50,
                60, true, 30000);

        Auto<Integer, Integer, Integer> FORD = new Auto<>("FORD", 2002, 30,
                50, false, 10000);

        container.add(TESLA);
        container.add(BMW);
        container.add(MERCEDES);
        container.add(FORD);

        //container.sortByReleaseYear();
        //container.sortByFuel();
        ...
        container.xml_load("save_lab_10.txt");
        container.sortByPrice();
        container.carList();
