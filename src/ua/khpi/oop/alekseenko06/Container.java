...
public class Container implements Serializable{
    ...
    public boolean equals ( Container container ) {
        return container.textToString().equals(textToString());
    }

    public void sortInputText () {
        if ( InputText == null ) {
            System.err.println("InputText is NULL");
            return;
        } else if ( InputText[0].equals("") ) {
            System.err.println("Input text correctly please.");
            return;
        }
